...
module Qeemono
  ...
  class Notificator
    ...
    NOTIFICATION_MESSAGES = {
      ...
      2021 => "Client '${client_id}' cannot be unsubscribed from channel '${channel_symbol}'. Not subscribed.",
      2030 => "Client '${client_id}' cannot be subscribed to channel '${channel_symbol}'! Not existing.",
      2031 => "Client '${client_id}' tried to subscribe to invalid channel '${channel_symbol}'! Ignoring.",
      ...
      2054 => "Client '${client_id}' tried to create channel '${channel_symbol}'! Not possible since it is a system channel.",
